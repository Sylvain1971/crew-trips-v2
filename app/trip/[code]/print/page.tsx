  ...
  useEffect(() => {
    async function load() {
      ...
      if (c) {
        ...
        // Phase 2 : bucket en transition vers privé. Signer les fichier_url
        // avant affichage. En Phase 1 (bucket encore public), fallback sur URL
        // originale — aucune régression.

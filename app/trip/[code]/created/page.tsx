  ...
  return (
    <main style={{ minHeight: '100dvh', background: 'var(--forest)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 20px' }}>
      <div style={{ width: '100%', maxWidth: 420, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'rgba(255,255,255,.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 36, marginBottom: 16 }}>
          ✅
        </div>
        ...
        <a href={url} style={{ display: 'block', width: '100%', background: 'rgba(255,255,255,.08)', borderRadius: 14, padding: '14px 16px', border: '1.5px solid rgba(255,255,255,.15)', textDecoration: 'none', marginBottom: 10, boxSizing: 'border-box' }}>
          <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,.4)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 6 }}>
            🔗 Lien du trip — appuyez pour ouvrir
          </div>
        ...
        <div style={{ display: 'flex', gap: 10, width: '100%', marginBottom: 24 }}>
          <button onClick={copy} style={{ flex: 1, padding: '12px', borderRadius: 12, border: '1.5px solid rgba(255,255,255,.2)', background: copied ? 'rgba(255,255,255,.2)' : 'rgba(255,255,255,.08)', color: '#fff', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
            {copied ? '✓ Copié !' : '📋 Copier'}
          </button>
        ...
        <div style={{ width: '100%', background: 'rgba(255,255,255,.06)', borderRadius: 14, padding: '16px', border: '1px solid rgba(255,255,255,.1)', boxSizing: 'border-box' }}>
          <div style={{ fontWeight: 700, fontSize: 13, color: '#fff', marginBottom: 10 }}>📱 Installer sur l'écran d'accueil</div>
          ...
          <div style={{ marginTop: 10, padding: '8px 12px', background: 'rgba(250,204,21,.08)', borderRadius: 8, border: '1px solid rgba(250,204,21,.2)', fontSize: 11, color: 'rgba(250,204,21,.9)', lineHeight: 1.5 }}>
            ⚠️ Installez depuis cette page — l'app s'ouvrira directement sur ce trip.
          </div>
        </div>
